...
# # UPDATED VERSION - Enhanced PKNIC API support with fallback methods
# # """
...
# #             print(f"   🔍 Querying PKNIC API for {domain_to_query}...")
...
# #                     # Format 1: Check if domain is registered
...
# #                                 print("   ✅ DNS records confirm domain exists (see DNS enumeration above)\n")
...
# #                     print(f"   ⚠️  API response parsing failed, trying alternative method...")
# #                     alt_data = self._pknic_web_scrape(domain_to_query)
# #                     if alt_data:
# #                         self._display_whois_data(alt_data)
# #                         self.results['whois'] = alt_data
...
# #         # If all methods fail
# #         print("   ℹ️  WHOIS data unavailable, but domain appears to be registered")
...
# #             print(f"ℹ️  Info: {whois_data.get('information')}")
...
# #         """Format WHOIS dates properly - handles lists and datetime objects"""
...
# #             print("🇵🇰 Detected .pk domain - Using PKNIC lookup\n")
...
# #                 print(f"❌ {record_type} Records: Error - {str(e)}\n")
        
# #         if not found_any:
# #             print("⚠️  No DNS records found. Domain may not be configured.\n")
...
# #                 print(f"   🔄 Attempting zone transfer from {ns_name}...")
...
# #         """Extract subdomains from SSL certificate's Subject Alternative Names"""
# #         subdomains = set()
...
# #         """Brute force common subdomains using DNS queries"""
# #         common_subs = [
...
# #         """Complete subdomain enumeration without external APIs"""
# #         logger.info(f"Starting API-free subdomain enumeration for {self.domain}")
# #         print(f"{'='*60}")
